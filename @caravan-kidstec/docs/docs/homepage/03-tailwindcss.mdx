...
Tailwind CSS は [`postcss.config.ts`](https://github.com/OpenUp-LabTakizawa/caravan-kidstec/blob/main/%40caravan-kidstec/web/postcss.config.ts) や [`globals.css`](https://github.com/OpenUp-LabTakizawa/caravan-kidstec/blob/main/%40caravan-kidstec/web/app/globals.css) で設定を行っています。
