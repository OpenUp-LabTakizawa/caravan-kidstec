...
export function ScrollToTop(): JSX.Element {
  ...
  return (
    <button
      ...
      ref={ref}
      onClick={scrollToTop}
      className={`bg-sky-400 border-sky-400 bottom-2 button-pop fixed font-bold leading-4 right-2 rounded-lg shadow-lg size-12 text-sm z-10 hover:bg-sky-500 sm:bottom-4 sm:right-4${scrollY < scrollPoint && !isScrollDown ? " hidden" : ""} ${scrollY < scrollPoint ? "fade-out-down" : "cursor-pointer fade-in-up"}`}
    >
