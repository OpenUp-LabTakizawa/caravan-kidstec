...
export function Modal({
  ...
  return (
    ...
    >
      <div className="bg-white col-start-1 duration-200 ease-out max-h-[90vh] max-w-3xl overflow-y-auto overscroll-contain p-2 pt-7 rounded-2xl row-start-1 scale-90 shadow-2xl space-y-2 transition w-full group-open:scale-100 group-open:translate-y-0 sm:p-6 sm:space-y-4">
        <button
          type="button"
          onClick={router.back}
