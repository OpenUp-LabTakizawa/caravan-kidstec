...
export function Modal({
  ...
  return (
    <dialog
      ...
      onClose={closeModal}
      className={
        "bg-transparent grid h-full items-center justify-items-center max-h-none max-w-none opacity-0 overflow-hidden overscroll-contain pointer-events-none w-full z-50 backdrop:bg-[#0006] open:opacity-100 open:pointer-events-auto open:visible"
      }
    >
      <div
