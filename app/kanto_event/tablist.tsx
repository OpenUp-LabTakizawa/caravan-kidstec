...
export function Tablist({
  ...
  return (
    <section className="max-w-lg mx-auto px-2 space-y-2 text-center sm:pb-6">
      ...
      {schedules.map((schedule, index) => (
        <div
          ...
          onTouchStart={() => setIsBusy(true)}
          onTouchEnd={() => setIsBusy(false)}
          className={`h-104 perspective-midrange${schedule.venue === tab ? "" : " hidden"}`}
        >
          <div
...
function TabCard({
  ...
  return (
    <>
      ...
      />
      <div className="bg-amber-50 h-42 py-1 relative rounded-b-2xl shadow-2xl space-y-2 sm:h-40 sm:py-2">
        ...
        <h3 className="flex font-bold items-center justify-center h-12 mx-auto text-base whitespace-pre sm:text-lg">
