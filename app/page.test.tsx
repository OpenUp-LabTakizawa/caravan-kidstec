...
describe("Home", () => {
  ...
  test("section test", () => {
    ...
    expect(sections[5]?.className).toEqual("gap-2 grid grid-cols-2")
    expect(sections[6]?.className).toEqual("gap-4 grid")
    expect(sections[7]?.className).toEqual("gap-4 grid relative")
  })
})
