      ...
      <>
        {reviews.map((item) => (
          <div key={item.description} className="carousel-item">
            <div className="bg-zinc-100 content-between gap-2 grid h-full p-2 rounded-2xl shadow-lg w-56">
  ...
  function Reviews3(): React.JSX.Element {
    ...
    return (
      <>
        {reviews.map((item) => (
          <div key={item.description} className="carousel-item">
            <div className="bg-yellow-50 content-between gap-2 grid h-full p-2 rounded-2xl shadow-lg w-56">
              <p className="my-auto text-sm whitespace-pre">
                {item.description}
              </p>
              <p className="flex h-fit items-center justify-center text-sm whitespace-pre">
